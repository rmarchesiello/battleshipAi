import itertools
from . import game_config, human_player, randomai_player, cheatingai_player
...
class Game(object):
    ...
    def setup_players(self, num_players: int) -> None:
        ...
        self.players.append(cheatingai_player.CheatingAIPlayer(2, self.game_config, self.players))
